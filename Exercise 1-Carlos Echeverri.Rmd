...
tmp = (xVec[-(249:250)] + (2*(xVec[-c(1, 250)])) - (xVec[-(1:2)]))
...
******
```{r}
1 + sum(cumprod(seq(2, 38, by=2))/cumprod(seq(3, 39, by=2)))
```
******
